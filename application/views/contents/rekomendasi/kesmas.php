            ...
            <div class="box-body">
              <table id="example5" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th rowspan="2">Jenis kesmas</th>
                  <th rowspan="2">Keterangan</th>
                  <th colspan="4" class="text-center">Alur Proses</th>
                </tr>
                <tr>
                  <th>1. Kesmas <i class="fa fa-arrow-right"></i></th> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="box">
            ...
            <div class="box-body">             
                <div class="form-group">
                  <label>1. kesmas</label>
                  <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input type="text" name="kesmas1" class="form-control pull-right" value="" id="datepicker3">
                </div>
                </div>
                <div class="form-group">
                  <label>2. TU</label>
...
<script type="text/javascript" src="<?php echo base_url(); ?>asset/js/rekomendasi/kesmas.js"></script>

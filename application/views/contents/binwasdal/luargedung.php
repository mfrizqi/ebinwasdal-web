...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Luar Gedung</li>
    </ol>
  </section>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <div class="form-group">
                  <label>Lintor</label>
                  <input type="text" name="lintor" class="form-control" required="Tidak boleh kosong">
                </div>
                ...
                <div class="form-group">
                  <label>Tujuan</label>
                  <input type="text" name="tujuan" class="form-control" required="Tidak boleh kosong">
                </div>
                <div class="form-group">
                  <label>Petugas</label>
                  <input type="text" name="petugas" class="form-control" required="Tidak boleh kosong">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputFile">Tambahkan Foto < 100kb (Jpg,Jpeg & PNG)</label> <input type="file" id="exampleInputFile" accept="image/*" onchange="ConvertFile();">
...
<script type="text/javascript" src="<?php echo base_url(); ?>asset/js/JsBarcode.all.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>asset/js/binwasdal/luargedung.js"></script>
$(document).ready( function () {
    ...
    function validasi(){
      ...
      var text ="";
      if ($('[name="jenis"]').val() == ""){
        text += "- Jenis SDK tidak boleh kosong <br> ";
        validasi = false;
      }
    ...
    function simpan(){
      if (validasi()){
      if (save_method == 1){
          var url = "../rekomendasi/Sdk/Simpan";
      }else {
        var url = "../rekomendasi/Sdk/Update";
      }
    $.ajax({
            url : url,
            type: "POST",
    ...
    function remove(id)
    {
      ...
      .one('click', '#delete', function(e) {
        $.post("../rekomendasi/Sdk/hapus/" + id, function( data ) {
          console.log(id);
          refresh();

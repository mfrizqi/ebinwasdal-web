$(document).ready( function () {
    ...
    function validasi(){
      ...
      var text ="";
      if ($('[name="nomou"]').val() == ""){
        text += "- No. MOU tidak boleh kosong <br> ";
        validasi = false;
      }
    ...
    function edit(id){
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name=nomou]').val(data.nomou);
            $('[name=tu1]').val(data.tu1);
            $('[name=kasudin2]').val(data.kasudin2);
            $('[name=tu3]').val(data.tu3);
    ...
    function simpan(){
      if (validasi()){
      if (save_method == 1){
          var url = "../rekomendasi/Tu/Simpan";
      }else {
        var url = "../rekomendasi/Tu/Update";
      }
    $.ajax({
            url : url,
            type: "POST",
    ...
    function remove(id)
    {
      ...
      .one('click', '#delete', function(e) {
        $.post("../rekomendasi/Tu/hapus/" + id, function( data ) {
          console.log(id);
          refresh();

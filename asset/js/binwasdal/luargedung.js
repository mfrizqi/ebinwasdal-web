$(document).ready(function () {
  ...
  $('#calendar').fullCalendar({
    ...
    events: '../binwasdal/Luargedung/getlist',
    //editable: true,
...
function edit(id) {
  ...
  $.ajax({
    url: "../binwasdal/Luargedung/Edit/" + id,
    type: "GET",
    dataType: "JSON",
  ...
  // get foto
  $.ajax({
    url: "../binwasdal/Luargedung/getFoto/" + id,
    type: "GET",
    dataType: "JSON",
    success: function (data) {
...
function simpan() {
  if (validasi()) {
    if (save_method == 1) {
      var url = "../binwasdal/Luargedung/Simpan";
    } else {
      var url = "../binwasdal/Luargedung/Update";
    }
    $.ajax({
      url: url,
      type: "POST",
...
function removeyes() {
  ...
  $.ajax({
    url: "../binwasdal/Luargedung/hapus/" + idv,
    type: "POST",
    data: $('#form').serialize(),
    dataType: "JSON",
    success: function (data) {
...
function deleteImg(id) {
  ...
  $.ajax({
    url: "../binwasdal/Luargedung/hapusImg/" + id,
    type: "POST",
    data: $('#form').serialize(),
    dataType: "JSON",
    success: function (data) {

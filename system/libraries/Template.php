...
class CI_Template
{
	...
	private function _guess_title()
	{
		...
		// {
            // $this->_ci->db->where(T_SystemControllers_alias,$this->_controller);
            // $query = $this->_ci->db->get(T_SystemControllers);
            // $con = ($query->num_rows() > 0) ? unserialize($query->first_row()->{T_SystemControllers_title}) : $this->_controller;
		...
		// {
            // $this->_ci->db->where(T_SystemModules_alias,$this->_module);
            // $query = $this->_ci->db->get(T_SystemModules);
            
            // if($query->num_rows() > 0):
	            // $mod = unserialize($query->first_row()->{T_SystemModules_title});
